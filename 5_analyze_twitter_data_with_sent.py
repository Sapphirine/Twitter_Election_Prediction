...
with open("election_tweets_copy.csv", "rb") as f:
    ...
    for i, line in enumerate(reader):
        ...
        if line[3] == 'Clinton':
            ...
            candidate_count_list[0] += 1*(1-.392)

            if line[4] not in candidate_count_dict:
                candidate_count_dict[line[4]] = [0]*7
                candidate_count_dict[line[4]][0] += 1*(1-.392)
            else:
                candidate_count_dict[line[4]][0] += 1*(1-.392)

        if line[3] == 'Sanders':
            sanders_tweet_count += 1
            candidate_count_list[1] += 1*(1-.355)

            if line[4] not in candidate_count_dict:
                candidate_count_dict[line[4]] = [0]*7
                candidate_count_dict[line[4]][1] += 1*(1-.355)
            else:
                candidate_count_dict[line[4]][1] += 1*(1-.355)

        if line[3] == 'Trump':
            trump_tweet_count += 1
            candidate_count_list[2] += 1*(1-.321)

            if line[4] not in candidate_count_dict:
                candidate_count_dict[line[4]] = [0]*7
                candidate_count_dict[line[4]][2] += 1*(1-.321)
            else:
                candidate_count_dict[line[4]][2] += 1*(1-.321)

        if line[3] == 'Cruz':
            cruz_tweet_count += 1
            candidate_count_list[3] += 1*(1-.214)

            if line[4] not in candidate_count_dict:
                candidate_count_dict[line[4]] = [0]*7
                candidate_count_dict[line[4]][3] += 1*(1-.214)
            else:
                candidate_count_dict[line[4]][3] += 1*(1-.214)

        if line[3] == 'Kasich':
            kasich_tweet_count += 1
            candidate_count_list[4] += 1*(1-.6)

            if line[4] not in candidate_count_dict:
                candidate_count_dict[line[4]] = [0]*7
                candidate_count_dict[line[4]][4] += 1*(1-.6)
            else:
                candidate_count_dict[line[4]][4] += 1*(1-.6)

        if line[3] == 'Rubio':
            rubio_tweet_count += 1
            candidate_count_list[5] += 1*(1-.272)

            if line[4] not in candidate_count_dict:
                candidate_count_dict[line[4]] = [0]*7
                candidate_count_dict[line[4]][5] += 1*(1-.272)
            else:
                candidate_count_dict[line[4]][5] += 1*(1-.272)

        if line[3] == 'Carson':
            carson_tweet_count += 1
            candidate_count_list[6] += 1*(1-.392)

            if line[4] not in candidate_count_dict:
                candidate_count_dict[line[4]] = [0]*7
                candidate_count_dict[line[4]][6] += 1*(1-.392)
            else:
                candidate_count_dict[line[4]][6] += 1*(1-.392)

clinton_tweet_count = clinton_tweet_count
candidate_count_list[0] = candidate_count_list[0]
trump_tweet_count = trump_tweet_count
candidate_count_list[2] = candidate_count_list[2]
print 'asdfasdfasfd ' + str(clinton_tweet_count)
